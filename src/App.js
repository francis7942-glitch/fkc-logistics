...
_st.textContent = `*,*::before,*::after{box-sizing:border-box;margin:0;padding:0} :root{ --bg:#0d1117;--sur:#161b22;--sur2:#1c2331;--sur3:#21262d; --bd:#30363d;--bd2:#3d444d;--tx:#e6edf3;--tx2:#8b949e;--tx3:#484f58; --ac:#00d4aa;--ac2:#00b894;--acd:rgba(0,212,170,.12); --rd:#f85149;--rdd:rgba(248,81,73,.12); --or:#e3b341;--ord:rgba(227,179,65,.12); --bl:#58a6ff;--bld:rgba(88,166,255,.12); --pu:#bc8cff;--pud:rgba(188,140,255,.12); --gr:#3fb950;--grd:rgba(63,185,80,.12); --r:8px;--rl:12px;--sb:224px;--sh:0 4px 24px rgba(0,0,0,.4); } body{font-family:'Mulish',sans-serif;background:var(--bg);color:var(--tx)} input,select,textarea,button{font-family:inherit} button{cursor:pointer} ::-webkit-scrollbar{width:6px;height:6px} ::-webkit-scrollbar-track{background:var(--sur)} ::-webkit-scrollbar-thumb{background:var(--bd2);border-radius:3px} .lw{min-height:100vh;display:flex;align-items:center;justify-content:center; background:radial-gradient(ellipse at 20% 50%,rgba(0,212,170,.08) 0%,transparent 60%), radial-gradient(ellipse at 80% 20%,rgba(88,166,255,.06) 0%,transparent 50%),var(--bg)} .lc{width:380px;background:var(--sur);border:1px solid var(--bd);border-radius:16px;padding:40px 36px;box-shadow:var(--sh)} .lbrand{display:flex;align-items:center;gap:10px;margin-bottom:6px} .lbrand-icon{width:44px;height:44px;background:#fff;border-radius:12px;display:flex;align-items:center;justify-content:center;overflow:hidden;padding:3px;flex-shrink:0} .lbrand-name{font-family:'Syne',sans-serif;font-size:22px;font-weight:800} .lsub{font-size:13px;color:var(--tx2);margin-bottom:32px} .fl{font-size:12px;font-weight:700;color:var(--tx2);letter-spacing:.06em;text-transform:uppercase;margin-bottom:6px;display:block} .fi{width:100%;padding:10px 14px;background:var(--sur3);border:1px solid var(--bd);border-radius:var(--r);color:var(--tx);font-size:14px;outline:none;transition:border .15s} .fi:focus{border-color:var(--ac)} .fgrp{margin-bottom:16px} .pww{position:relative}.pww .fi{padding-right:40px} .pwt{position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;color:var(--tx2);font-size:16px;padding:0} .lbtn{width:100%;margin-top:8px;padding:12px;background:var(--ac);color:#0d1117;border:none;border-radius:var(--r);font-size:14px;font-weight:800;letter-spacing:.04em;font-family:'Syne',sans-serif;transition:background .15s} .lbtn:hover{background:var(--ac2)}.lbtn:disabled{opacity:.6} .err-bar{background:var(--rdd);border:1px solid var(--rd);color:var(--rd);border-radius:var(--r);padding:10px 14px;font-size:13px;margin-bottom:16px} .ok-bar{background:var(--acd);border:1px solid var(--ac);color:var(--ac);border-radius:var(--r);padding:10px 14px;font-size:13px;margin-bottom:16px} .shell{display:flex;min-height:100vh} .sidebar{width:var(--sb);background:var(--sur);border-right:1px solid var(--bd);display:flex;flex-direction:column;position:fixed;top:0;left:0;height:100vh;z-index:50;transition:transform .25s} .sbrand{display:flex;align-items:center;gap:9px;padding:20px 16px 16px;border-bottom:1px solid var(--bd)} .sbrand-icon{width:32px;height:32px;background:#fff;border-radius:8px;display:flex;align-items:center;justify-content:center;overflow:hidden;padding:2px;flex-shrink:0} .sbrand-name{font-family:'Syne',sans-serif;font-size:15px;font-weight:800} .snav{flex:1;padding:10px 8px;overflow-y:auto;display:flex;flex-direction:column;gap:1px} .nsec{font-size:10px;font-weight:800;color:var(--tx3);letter-spacing:.1em;text-transform:uppercase;padding:12px 12px 4px} .nb{display:flex;align-items:center;gap:10px;padding:9px 12px;border:none;background:none;border-radius:var(--r);color:var(--tx2);font-size:13.5px;font-weight:600;width:100%;text-align:left;transition:all .15s} .nb:hover{background:var(--sur3);color:var(--tx)}.nb.on{background:var(--acd);color:var(--ac)} .sfoot{padding:12px;border-top:1px solid var(--bd)} .urow{display:flex;align-items:center;gap:9px;margin-bottom:8px} .uav{width:32px;height:32px;background:var(--acd);border:1px solid rgba(0,212,170,.3);border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:'Syne',sans-serif;font-weight:800;font-size:13px;color:var(--ac);flex-shrink:0} .uname{font-size:13px;font-weight:700}.urole{font-size:11px;color:var(--tx2);text-transform:capitalize} .lobtn{width:100%;padding:8px;background:var(--sur3);border:1px solid var(--bd);border-radius:var(--r);color:var(--tx2);font-size:12px;font-weight:700;transition:all .15s} .lobtn:hover{border-color:var(--rd);color:var(--rd);background:var(--rdd)} .main{margin-left:var(--sb);flex:1;display:flex;flex-direction:column;min-height:100vh} .topbar{display:none;padding:14px 18px;background:var(--sur);border-bottom:1px solid var(--bd);align-items:center;gap:12px;position:sticky;top:0;z-index:40} .hbg{background:none;border:none;color:var(--tx2);font-size:20px;line-height:1} .ttl{font-family:'Syne',sans-serif;font-weight:700;font-size:15px} .bkd{display:none;position:fixed;inset:0;background:rgba(0,0,0,.6);z-index:49} .con{padding:28px 32px;max-width:1160px} .ph{display:flex;align-items:center;gap:12px;margin-bottom:24px;flex-wrap:wrap} .ph h2{font-family:'Syne',sans-serif;font-size:22px;font-weight:800} .phi{width:38px;height:38px;border-radius:9px;display:flex;align-items:center;justify-content:center;font-size:18px;flex-shrink:0} .phi.teal{background:var(--acd);border:1px solid rgba(0,212,170,.25)} .phi.red{background:var(--rdd);border:1px solid rgba(248,81,73,.25)} .phi.or{background:var(--ord);border:1px solid rgba(227,179,65,.25)} .phi.bl{background:var(--bld);border:1px solid rgba(88,166,255,.25)} .phi.pu{background:var(--pud);border:1px solid rgba(188,140,255,.25)} .phi.gr{background:var(--grd);border:1px solid rgba(63,185,80,.25)} .mla{margin-left:auto} .sgrid{display:grid;grid-template-columns:repeat(5,1fr);gap:12px;margin-bottom:24px} .sc{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);padding:15px 17px;display:flex;align-items:center;gap:12px} .sico{font-size:20px}.sval{font-family:'JetBrains Mono',monospace;font-size:14px;font-weight:500;line-height:1.2} .slbl{font-size:10px;color:var(--tx2);font-weight:700;letter-spacing:.05em;text-transform:uppercase;margin-top:3px} .btn{display:inline-flex;align-items:center;gap:6px;padding:9px 18px;border-radius:var(--r);font-size:13px;font-weight:700;border:none;transition:all .15s;white-space:nowrap} .bac{background:var(--ac);color:#0d1117}.bac:hover{background:var(--ac2)} .brd{background:var(--rdd);color:var(--rd);border:1px solid rgba(248,81,73,.3)}.brd:hover{background:var(--rd);color:#fff} .bgh{background:var(--sur3);color:var(--tx2);border:1px solid var(--bd)}.bgh:hover{border-color:var(--bd2);color:var(--tx)} .btn:disabled{opacity:.5;cursor:not-allowed} .ib{background:none;border:none;color:var(--tx2);padding:5px;border-radius:6px;font-size:15px;display:inline-flex;transition:all .15s} .ib:hover{background:var(--sur3);color:var(--tx)}.ib.dl:hover{background:var(--rdd);color:var(--rd)} .fgrid{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:22px} .fg{display:flex;flex-direction:column;gap:7px}.fg.s2{grid-column:span 2} .fg label{font-size:12px;font-weight:700;color:var(--tx2);letter-spacing:.05em;text-transform:uppercase} .fg input,.fg select,.fg textarea{padding:10px 13px;background:var(--sur3);border:1px solid var(--bd);border-radius:var(--r);color:var(--tx);font-size:14px;outline:none;transition:border .15s;resize:vertical} .fg input:focus,.fg select:focus,.fg textarea:focus{border-color:var(--ac)} .fg select option{background:var(--sur3)}.fg input:disabled,.fg select:disabled{opacity:.45;cursor:not-allowed} .iselr{display:flex}.iselr select{flex:1;border-radius:var(--r) 0 0 var(--r) !important} .iselt{padding:0 12px;background:var(--sur2);border:1px solid var(--bd);border-left:none;border-radius:0 var(--r) var(--r) 0;display:flex;align-items:center;font-size:11px;font-family:'JetBrains Mono',monospace;color:var(--tx2);white-space:nowrap} .pills{display:flex;gap:6px;flex-wrap:wrap;margin-top:7px} .pill{padding:3px 10px;border-radius:20px;font-size:11px;font-weight:700;border:1px solid} .p-teal{background:var(--acd);color:var(--ac);border-color:rgba(0,212,170,.25)} .p-blue{background:var(--bld);color:var(--bl);border-color:rgba(88,166,255,.25)} .p-or{background:var(--ord);color:var(--or);border-color:rgba(227,179,65,.25)} .p-mu{background:var(--sur2);color:var(--tx2);border-color:var(--bd)} .p-loc{background:var(--pud);color:var(--pu);border-color:rgba(188,140,255,.25)} .tw{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);overflow:auto} table{width:100%;border-collapse:collapse;font-size:13px} thead th{background:var(--sur2);padding:11px 14px;text-align:left;font-size:11px;font-weight:700;color:var(--tx2);letter-spacing:.06em;text-transform:uppercase;border-bottom:1px solid var(--bd);white-space:nowrap} tbody tr{border-bottom:1px solid var(--bd);transition:background .1s} tbody tr:last-child{border-bottom:none} tbody tr:hover{background:var(--sur2)} tbody td{padding:11px 14px;vertical-align:middle} .erow td{text-align:center;color:var(--tx3);padding:48px !important} .bdg{display:inline-block;padding:3px 9px;border-radius:20px;font-size:11px;font-weight:700;font-family:'JetBrains Mono',monospace} .b-in{background:var(--acd);color:var(--ac);border:1px solid rgba(0,212,170,.2)} .b-out{background:var(--rdd);color:var(--rd);border:1px solid rgba(248,81,73,.2)} .b-adm{background:var(--bld);color:var(--bl);border:1px solid rgba(88,166,255,.2)} .b-per{background:var(--ord);color:var(--or);border:1px solid rgba(227,179,65,.2)} .b-on{background:var(--grd);color:var(--gr)}.b-off{background:var(--sur3);color:var(--tx3)} .b-frz{background:var(--bld);color:var(--bl)}.b-chl{background:var(--acd);color:var(--ac)} .b-dry{background:var(--ord);color:var(--or)}.b-loc{background:var(--pud);color:var(--pu)} .fbar{display:flex;gap:8px;flex-wrap:wrap;align-items:center} .fbar select,.fbar input{padding:8px 12px;background:var(--sur3);border:1px solid var(--bd);border-radius:var(--r);color:var(--tx);font-size:13px;outline:none} .chip-bar{display:flex;gap:6px;flex-wrap:wrap} .chip{padding:6px 14px;border-radius:20px;font-size:12px;font-weight:700;border:1px solid var(--bd);background:var(--sur3);color:var(--tx2);cursor:pointer;transition:all .15s} .chip:hover{border-color:var(--bd2);color:var(--tx)} .chip.act{background:var(--acd);border-color:var(--ac);color:var(--ac)} .chip.act-bl{background:var(--bld);border-color:var(--bl);color:var(--bl)} .chip.act-or{background:var(--ord);border-color:var(--or);color:var(--or)} .ov{position:fixed;inset:0;background:rgba(0,0,0,.7);z-index:200;display:flex;align-items:center;justify-content:center;padding:20px} .mdl{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);width:100%;max-width:520px;box-shadow:var(--sh);max-height:90vh;display:flex;flex-direction:column} .mdl.wide{max-width:680px} .mhd{display:flex;align-items:center;justify-content:space-between;padding:18px 22px;border-bottom:1px solid var(--bd);flex-shrink:0} .mhd span{font-family:'Syne',sans-serif;font-weight:700;font-size:16px} .mhd button{background:none;border:none;color:var(--tx2);font-size:18px;padding:2px 6px;border-radius:6px} .mhd button:hover{background:var(--sur3)} .mbd{padding:22px;overflow-y:auto}.mft{display:flex;justify-content:flex-end;gap:10px;margin-top:20px} .spin-wrap{display:flex;align-items:center;justify-content:center;padding:60px;color:var(--tx3);gap:12px;font-size:13px} @keyframes spin{to{transform:rotate(360deg)}} .spin-ico{width:22px;height:22px;border:2px solid var(--bd);border-top-color:var(--ac);border-radius:50%;animation:spin .7s linear infinite} .kpi-row{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:24px} .kpi{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);padding:18px 20px;position:relative;overflow:hidden} .kpi::before{content:'';position:absolute;top:0;left:0;right:0;height:2px} .kpi.k-ac::before{background:var(--ac)}.kpi.k-bl::before{background:var(--bl)} .kpi.k-or::before{background:var(--or)}.kpi.k-pu::before{background:var(--pu)} .kpi-label{font-size:11px;font-weight:700;color:var(--tx2);letter-spacing:.06em;text-transform:uppercase;margin-bottom:8px} .kpi-val{font-family:'JetBrains Mono',monospace;font-size:20px;font-weight:500} .kpi-sub{font-size:12px;margin-top:6px} .kpi-up{color:var(--ac)}.kpi-dn{color:var(--rd)}.kpi-na{color:var(--tx3)} .chart-card{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);padding:20px 24px;margin-bottom:16px} .chart-card-hd{display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:20px;gap:12px;flex-wrap:wrap} .chart-card-title{font-family:'Syne',sans-serif;font-weight:700;font-size:14px} .chart-card-sub{font-size:12px;color:var(--tx2);margin-top:3px} .chart-legend{display:flex;gap:14px;flex-wrap:wrap} .leg-item{display:flex;align-items:center;gap:6px;font-size:12px;color:var(--tx2)} .leg-dot{width:10px;height:10px;border-radius:2px;flex-shrink:0} .chart-wrap{width:100%;overflow-x:auto} .perf-bar-bg{background:var(--sur3);border-radius:3px;height:6px;position:relative;overflow:hidden} .perf-bar-fill{position:absolute;left:0;top:0;height:100%;border-radius:3px;transition:width .4s} .bar-tooltip{position:fixed;background:var(--sur);border:1px solid var(--bd2);border-radius:var(--r);padding:10px 14px;font-size:12px;pointer-events:none;z-index:300;min-width:160px;box-shadow:var(--sh)} .tt-month{font-family:'Syne',sans-serif;font-weight:700;font-size:13px;margin-bottom:6px} .tt-row{display:flex;justify-content:space-between;gap:16px;padding:2px 0} .tt-dot{width:8px;height:8px;border-radius:2px;display:inline-block;margin-right:5px;flex-shrink:0} .inv-wrap{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);overflow:hidden} .inv-hd{display:flex;align-items:center;justify-content:space-between;padding:16px 20px;border-bottom:1px solid var(--bd);gap:12px;flex-wrap:wrap} .inv-title{font-family:'Syne',sans-serif;font-weight:700;font-size:15px} .inv-count{font-size:12px;color:var(--tx2);background:var(--sur3);border:1px solid var(--bd);border-radius:20px;padding:2px 10px;font-family:'JetBrains Mono',monospace} .inv-filters{display:flex;gap:8px;flex-wrap:wrap;align-items:center;padding:12px 20px;border-bottom:1px solid var(--bd);background:var(--sur2)} .loc-cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:10px;padding:14px 20px;border-bottom:1px solid var(--bd)} .loc-card{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);padding:14px 16px;cursor:pointer;transition:border-color .15s} .loc-card:hover,.loc-card.sel{border-color:var(--pu)}.loc-card.sel{background:var(--pud)} .loc-card-name{font-family:'Syne',sans-serif;font-weight:700;font-size:13px;margin-bottom:6px} .loc-stat{font-size:11px;color:var(--tx2)}.loc-stat strong{color:var(--tx);font-family:'JetBrains Mono',monospace} .row-frz td:first-child{border-left:3px solid var(--bl)} .row-chl td:first-child{border-left:3px solid var(--ac)} .row-dry td:first-child{border-left:3px solid var(--or)} .ctr-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:14px} .ctr-card{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);overflow:hidden;transition:border-color .15s} .ctr-card.act-ctr{border-color:var(--or);border-width:1.5px} .ctr-hd{padding:16px 18px;border-bottom:1px solid var(--bd);display:flex;align-items:flex-start;justify-content:space-between;gap:8px} .ctr-client{font-family:'Syne',sans-serif;font-weight:700;font-size:14px} .ctr-ref{font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--tx2);margin-top:2px} .ctr-body{padding:14px 18px} .ctr-row{display:flex;justify-content:space-between;align-items:center;padding:5px 0;font-size:13px;border-bottom:1px solid var(--bd)} .ctr-row:last-child{border:none}.ctr-label{color:var(--tx2);font-size:12px} .ctr-val{font-family:'JetBrains Mono',monospace;font-weight:500} .ctr-foot{padding:10px 18px;background:var(--sur2);border-top:1px solid var(--bd);display:flex;gap:8px;justify-content:flex-end} .b-ctr-act{background:var(--ord);color:var(--or);border:1px solid rgba(227,179,65,.25)} .b-ctr-fut{background:var(--bld);color:var(--bl);border:1px solid rgba(88,166,255,.25)} .b-ctr-exp{background:var(--sur3);color:var(--tx3)} .info-box{background:var(--sur2);border:1px solid var(--bd);border-radius:var(--r);padding:12px 16px;font-size:13px;color:var(--tx2);line-height:1.6;margin-bottom:16px} .sp-alert-bar{display:flex;align-items:center;gap:10px;background:var(--rdd);border:1px solid rgba(248,81,73,.25);border-radius:var(--rl);padding:12px 18px;margin-bottom:20px;font-size:13px;color:var(--rd);flex-wrap:wrap} .sp-tabs{display:flex;gap:2px;background:var(--sur2);border:1px solid var(--bd);border-radius:9px;padding:3px;margin-bottom:22px;flex-wrap:wrap;width:fit-content} .sp-tab{padding:8px 16px;border:none;background:none;border-radius:7px;font-size:13px;font-weight:700;color:var(--tx2);cursor:pointer;transition:all .15s;white-space:nowrap} .sp-tab.on{background:var(--sur3);color:var(--tx);box-shadow:0 1px 4px rgba(0,0,0,.3)} .sp-cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:12px} .sp-card{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);overflow:hidden;transition:border-color .15s} .sp-card.alert{border-color:rgba(248,81,73,.4)!important}.sp-card.warn{border-color:rgba(227,179,65,.4)!important} .sp-card-hd{padding:14px 16px;display:flex;align-items:flex-start;justify-content:space-between;gap:8px;border-bottom:1px solid var(--bd)} .sp-card-name{font-weight:700;font-size:13.5px} .sp-card-pn{font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--tx2);margin-top:2px} .sp-card-body{padding:12px 16px;display:flex;flex-direction:column;gap:8px} .sp-stock-row{display:flex;align-items:center;justify-content:space-between} .sp-stock-num{font-family:'JetBrains Mono',monospace;font-size:22px;font-weight:600} .sp-stock-num.ok{color:var(--ac)}.sp-stock-num.warn{color:var(--or)}.sp-stock-num.low{color:var(--rd)} .sp-stock-bar{height:4px;background:var(--sur3);border-radius:2px;margin:2px 0 6px;overflow:hidden} .sp-stock-bar-fill{height:100%;border-radius:2px;transition:width .3s} .sp-meta{font-size:11px;color:var(--tx2);display:flex;gap:12px;flex-wrap:wrap} .sp-card-foot{padding:10px 16px;border-top:1px solid var(--bd);display:flex;gap:6px;justify-content:flex-end} .pr-card{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);padding:16px 18px;margin-bottom:10px;display:grid;grid-template-columns:1fr auto;gap:12px;align-items:start} .pr-card.urgent{border-color:rgba(248,81,73,.35)} .b-pr-open{background:var(--ord);color:var(--or)}.b-pr-ordered{background:var(--bld);color:var(--bl)}.b-pr-received{background:var(--grd);color:var(--gr)} .mach-card{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);padding:14px 16px} .mach-card-name{font-family:'Syne',sans-serif;font-weight:700;font-size:14px;margin-bottom:4px} .tbar{display:flex;gap:2px;background:var(--sur2);border:1px solid var(--bd);border-radius:9px;padding:3px;width:fit-content;margin-bottom:22px} .tab{padding:8px 20px;border:none;background:none;border-radius:7px;font-size:13px;font-weight:700;color:var(--tx2);transition:all .15s} .tab.on{background:var(--sur3);color:var(--tx);box-shadow:0 1px 4px rgba(0,0,0,.3)} .sbox{background:var(--sur);border:1px solid var(--bd);border-radius:var(--rl);padding:24px} .hint{font-size:13px;color:var(--tx2);margin-bottom:18px;line-height:1.6} @media(max-width:1000px){.sgrid{grid-template-columns:repeat(3,1fr)}.kpi-row{grid-template-columns:1fr 1fr}} @media(max-width:700px){ .sidebar{transform:translateX(-100%)}.sidebar.open{transform:none;box-shadow:4px 0 32px rgba(0,0,0,.5)} .bkd{display:block}.main{margin-left:0}.topbar{display:flex} .con{padding:18px 14px}.fgrid{grid-template-columns:1fr}.fg.s2{grid-column:span 1} .sgrid{grid-template-columns:1fr 1fr;gap:10px}.kpi-row{grid-template-columns:1fr 1fr} .ctr-grid{grid-template-columns:1fr}.sp-cards{grid-template-columns:1fr} } @media(max-width:420px){.sgrid{grid-template-columns:1fr}.kpi-row{grid-template-columns:1fr}}`;
...
<div style={{width:44,height:44,background:’#2CA01C’,borderRadius:10,display:‘flex’,alignItems:‘center’,justifyContent:‘center’,fontSize:22,flexShrink:0}}>📊</div>
<div><div style={{fontFamily:‘Syne’,fontWeight:700,fontSize:15}}>QuickBooks Online</div><div style={{fontSize:13,color:‘var(–tx2)’,marginTop:2}}>Push billing invoices directly to your QBO account</div></div>
<a href=”/.netlify/functions/qbo-auth” className=“btn bac mla” style={{background:’#2CA01C’,textDecoration:‘none’,color:’#fff’,padding:‘9px 18px’,borderRadius:‘var(–r)’,fontWeight:700,fontSize:13}}>🔗 Connect QuickBooks</a>
</div>
</div>
<div className="info-box">
<strong>How it works:</strong><br/>
...
4. Invoice appears instantly in your QBO — line items for storage, handling, and dry storage
</div>
</div>}
